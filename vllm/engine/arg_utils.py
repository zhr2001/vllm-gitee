...
class EngineArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            ...
            "-moe-tp",
            type=int,
            default=EngineArgs.moe_tensor_parallel_size,
            help="Number of tensor parallel replicas of MoE Layer.",
        )
        parser.add_argument(
            "--moe-expert-parallel-size",
            "-moe-ep",
            type=int,
            default=EngineArgs.moe_expert_parallel_size,
            help="Number of expert parallel replicas of MoE Layer.",
        )
        parser.add_argument(
    ...
    def create_engine_config(
        ...
        parallel_config = ParallelConfig(
            ...
            moe_tensor_model_parallel_size=self.moe_tensor_parallel_size,
            moe_expert_model_parallel_size=self.moe_expert_parallel_size,
